    ...
    <div class="admin-container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p>Masukkan informasi lengkap tentang barang persewaan</p>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.items.store') }}" enctype="multipart/form-data" id="itemForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" placeholder="Contoh: Kursi Tiffany, Dekorasi Bunga, Lampu Gantung" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <div class="info-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="stock" placeholder="Jumlah tersedia" value="{{ old('stock') }}" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Gambar Item <span class="required">*</span></label>
